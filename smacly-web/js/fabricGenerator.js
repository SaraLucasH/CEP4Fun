...
var SolidityGenerator = new Blockly.Generator('Fabric');
...
SolidityGenerator['contract'] = function(block) {
  ...
  if(inheritance_contract != ""){
    inheritance_contract = "inmplements" + inheritance_contract;
    code = labelContract + 'public class ' + contract_name + " " + inheritance_contract + "{\n" + statements_content + '}\n';
  }
  else{
    code = labelContract + 'public class ' + contract_name + " {\n" + statements_content + '}\n';
  }
  return code;
};
...
SolidityGenerator['contract_constructor'] = function(block) {
  ...
  if(constructor_payable != "TRUE"){
    if(inherance_constructor == ""){
      code = "public (" + inputparams_content + ') ' + constructor_visibility + "{\n" + statements_content + '}\n';
    }
    else{
      code = "public(" + inputparams_content + ') ' + inherance_constructor + ' ' + constructor_visibility + "{\n" + statements_content + '}\n';
    }
  }
  else{
    if(inherance_constructor == ""){
     code = "public(" + inputparams_content + ') ' + constructor_visibility + " payable" +  "{\n" + statements_content + '}\n';
    }
    else{
      code = "public(" + inputparams_content + ') ' + inherance_constructor + ' ' + constructor_visibility  + " payable" + "{\n" + statements_content + '}\n';
    }
 }
  return code;
};
...
SolidityGenerator['clause'] = function(block) {
  var labelTransaction = "@Transaction()" + '\n';
  ...
  if(function_personalizedmodifier == null){
    code = labelTransaction + function_visibility  + function_name + '(' + inputparams_content + ') '  + ' ' + function_valuesinputmodifier + ' ' + outputparam + "{\n" + 
    function_statements_content + "}\n";
  }
  else{
    code = labelTransaction + function_visibility + function_name + '(' + inputparams_content + ') ' + ' ' + function_valuesinputmodifier+ ' ' + function_personalizedmodifier + ' ' + outputparam + "{\n" + 
    function_statements_content + "}\n";
  }
  return code;
};
...
SolidityGenerator['text_property'] = function(block) {
  ...
  if(property_array == ""){
    if(property_constant == "TRUE"){
      code = labelProperty + property_type + ' ' + property_visibility + ' ' + "constant" + ' ' + property_storagedata_values + ' ' + property_name + ' ' + property_valueproperty +";\n";
    }
    else{
      code = labelProperty + property_type + ' ' + property_visibility + ' ' + property_storagedata_values + ' ' + property_name + ' ' + property_valueproperty +";\n";
    }
  }
  else{
    if(property_constant == "TRUE"){
      code = labelProperty + property_type + " " + property_array + ' ' + property_visibility + ' ' + "constant" + ' ' + property_storagedata_values + ' ' + property_name + ' ' + property_valueproperty +";\n";
    }
    else{
      code = labelProperty + property_type + " "  + property_array + ' ' + property_visibility + ' ' + property_storagedata_values + ' ' + property_name + ' ' + property_valueproperty +";\n";
    }
  }
  return code;
};
...
SolidityGenerator['boolean_property'] = function(block) {
  ...
  if(property_array == ""){
    if(property_constant == "TRUE"){
      code = labelProperty + "boolean" + ' ' + property_visibility + ' ' + "constant" + ' ' + property_storagedata_values + ' ' + property_name + ' ' + property_valueproperty +";\n";
    }
    else{
      code = labelProperty + "boolean" + ' ' + property_visibility + ' ' + property_storagedata_values + ' ' + property_name + ' ' + property_valueproperty +";\n";
    }
  }
  else{
    if(property_constant == "TRUE"){
      code = labelProperty + "boolean" + " " + property_array + ' ' + property_visibility + ' ' + "constant" + ' ' + property_storagedata_values + ' ' + property_name + ' ' + property_valueproperty +";\n";
    }
    else{
      code = labelProperty + "boolean" + " "  + property_array + ' ' + property_visibility + ' ' + property_storagedata_values + ' ' + property_name + ' ' + property_valueproperty +";\n";
    }
  }
  return code;
};
...
SolidityGenerator['user_property'] = function(block) {
  ...
  if(property_array == ""){
    if(property_constant == "TRUE"){
      code = labelProperty + "User" + ' ' + property_visibility + ' ' + "constant" + ' ' + property_storagedata_values + ' ' + property_name + ' ' + property_valueproperty +";\n";
    }
    else{
      code = labelProperty + "User" + ' ' + property_visibility + ' ' + property_storagedata_values + ' ' + property_name + ' ' + property_valueproperty +";\n";
    }
  }
  else{
    if(property_constant == "TRUE"){
      code = labelProperty + "User" + " " + property_array + ' ' + property_visibility + ' ' + "constant" + ' ' + property_storagedata_values + ' ' + property_name + ' ' + property_valueproperty +";\n";
    }
    else{
      code = labelProperty + "User" + " "  + property_array + ' ' + property_visibility + ' ' + property_storagedata_values + ' ' + property_name + ' ' + property_valueproperty +";\n";
    }
  }
  return code;
};
...
SolidityGenerator['company_property'] = function(block) {
  ...
  if(property_array == ""){
    if(property_constant == "TRUE"){
      code = labelProperty + "Company" + ' ' + property_visibility + ' ' + "constant" + ' ' + property_storagedata_values + ' ' + property_name + ' ' + property_valueproperty +";\n";
    }
    else{
      code = labelProperty + "Company" + ' ' + property_visibility + ' ' + property_storagedata_values + ' ' + property_name + ' ' + property_valueproperty +";\n";
    }
  }
  else{
    if(property_constant == "TRUE"){
      code = labelProperty + "Company" + " " + property_array + ' ' + property_visibility + ' ' + "constant" + ' ' + property_storagedata_values + ' ' + property_name + ' ' + property_valueproperty +";\n";
    }
    else{
      code = labelProperty + "Company" + " "  + property_array + ' ' + property_visibility + ' ' + property_storagedata_values + ' ' + property_name + ' ' + property_valueproperty +";\n";
    }
  }
  return code;
};
...
SolidityGenerator['mapping_property'] = function(block) {
  ...
  var code;
  if(property_constant == "TRUE"){
    code = labelProperty + "mapping " +  property_type + ' ' + property_visibility + ' ' + "constant" + ' ' + property_storagedata_values + ' ' + property_name + ' ' + property_valueproperty +";\n";
  }
  else{
    code = labelProperty + "mapping " + property_type + ' ' + property_visibility + ' ' + property_storagedata_values + ' ' + property_name + ' ' + property_valueproperty +";\n";
  }   return code;
};
